#' @title Informacje dla placowek nadrzednych
#' @description
#' Funkcja zwraca dla określonego numeru rspo dane placówki nadrzędnej
#' i zespołu, do którego (o ile) należy.
#' @param rspoStr ciąg znakowy z numerem rspo
#' @return
#' Funkcja zwraca listę, której elementy zawierają wektory ciągów znakowych
#' z danymi o placówce nadrzędnej i/lub zespołu.
#' @export
